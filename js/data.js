...
const RANDOM_COMMENTATOR_NAME = ['Михаил', 'Александр', 'Артём', 'Максим', 'Иван', 'Дмитрий', 'Марк', 'Лев', 'Матвей', 'Андрей', 'Арсений', 'Владимир', 'Николай', 'Егор', 'Даниил', 'Алексей', 'Роман', 'Степан', 'Кирилл', 'Игорь', 'Тимофей', 'Павел', 'Георгий', 'Сергей', 'Григорий'];
...
const makePhotoComments = () => ({
  ...
  name:getRandomArrayElement(RANDOM_COMMENTATOR_NAME)
});
...
const makePhotoDescription = () => ({
  ...
  description: getRandomArrayElement(PHOTO_DESCRIPTION_TEXT),
